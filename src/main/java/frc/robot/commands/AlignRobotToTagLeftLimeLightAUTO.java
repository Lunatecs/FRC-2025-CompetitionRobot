...
public class AlignRobotToTagLeftLimeLightAUTO extends Command {
  ...
  public AlignRobotToTagLeftLimeLightAUTO(ScoringLimeLightSubSystemLeft limelight, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric robotCentric, double MaxSpeed, double MaxAngularRate, PPHolonomicDriveController driveController) {
